...
public class Parser {
    ...
    private ArrayList<String> binaryLines; //todo should it be an ArrayList of string or an int?
    /** the current matcher*/
     ...
     * @return
     */
    public ArrayList<String> parseAsmFile()
    {
    ...
    private boolean dealWithAInstruction(String line){
        ...
        if(m.lookingAt()) //check if the line starts with the char '@'
        {
            ...
            if(m.lookingAt()) // check for digits that represent a location in the memory
            {
                ...
                //todo convert the numbers to binary
                return true;
            }
    ...
    private void dealWithCInstruction(String line){
        ...
        {
            this.curRegisters=line.substring(curMatcher.start(),curMatcher.end()-2); //the registers string
